...
# ############################################################## 2025.02.19 ################################################################
        ...
        # 중심성(Centrality) 계산 (Betweenness Centrality 예시)
        betweenness_centrality = nx.betweenness_centrality(nx_graph)
        # 다른 중심성 지표도 필요하다면 추가적으로 계산 (e.g., degree_centrality, closeness_centrality)
        ...
        # 만약 다른 중심성 지표도 사용한다면, 위와 같은 방식으로 tensor로 변환 후 node_attr에 concat
############################################################################################################################################
#############################################################[다운샘플링 코드 시작]###########################################################
